...
public class ImageDetailFragment extends Fragment {
	...
	public static ImageDetailFragment newInstance(String imageUrl,int mPosition,int mLocationX, int mLocationY,int mWidth,int mHeight) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mImageView.setOriginalInfo(Width, Height, LocationX, LocationY);
